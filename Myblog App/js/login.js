...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function handleGoogleCredentialResponse(response) {
        ...
        try {
            const selectedRoleEl = document.querySelector('input[name="googleLoginRole"]:checked');
            const requestedRole = selectedRoleEl ? selectedRoleEl.value : "user";

            // Send the signed Google ID token credential + role to backend
